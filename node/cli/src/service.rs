...
mod tests {
	...
	#[test]
	// It is "ignored", but the coinnet-node ignored tests are running on the CI.
	// This can be run locally with `cargo test --release -p coinnet-node test_sync -- --ignored`.
	#[ignore]
	fn test_sync() {
